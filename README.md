...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-01 11:01`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0583c455-78fa-4f2c-bc92-c16ddbf6eab0.git
$ cd 0583c455-78fa-4f2c-bc92-c16ddbf6eab0
```
